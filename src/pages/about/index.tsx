...
export class AboutComponent extends PureComponent {
    render () {
        ...
        <section className='mb-20' id='about'>
                ...
                <p className='paragraph dark:text-whiteish'>Innovative and detail-oriented frontend web developer with 10+ years of combined experience in web development and design, specializing in crafting visually appealing and highly functional user interfaces.
                </p>   
                <p className='paragraph dark:text-whiteish'>
